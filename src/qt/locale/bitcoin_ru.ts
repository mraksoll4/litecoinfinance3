...
<context>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети LitecoinFinance</numerusform><numerusform>%n активных подключения к сети LitecoinFinance</numerusform><numerusform>%n активных подключений к сети LitecoinFinance</numerusform><numerusform>%n активных подключений к сети Биткойн</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>'litecoinfinance://' не верный URI. Используйте 'litecoinfinance:' вместо этого.</translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Creates a Partially Signed LitecoinFinance Transaction (PSBT) for use with e.g. an offline %1 wallet, or a PSBT-compatible hardware wallet.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Please, review your transaction proposal. This will produce a Partially Signed LitecoinFinance Transaction (PSBT) which you can copy and then sign with e.g. an offline %1 wallet, or a PSBT-compatible hardware wallet.</translation>
    </message>
    <message>
        <source>or</source>
